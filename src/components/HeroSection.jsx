          ...
          >
            ...
            >
              ...
              <p className="font-sans text-sm md:text-base text-blue-100/50 max-w-xl leading-7 mt-3">
                Informatics Student @ ITK — specializing in the intersection of <span className="text-white">Cloud/DevOps</span>, <span className="text-white">MLOps</span>, and <span className="text-white">Full Stack Web Development</span>.
              </p>
            </Gsap.div>
